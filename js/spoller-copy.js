...
const spollersRegular = Array.from(spollersArray).filter(function(item, index, self) { //spollersRegular изначально коллекция и с помощью Array.from переводим ее в массив
